...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ReconocerTexto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (uri==null){
                    Toast.makeText(MainActivity.this, "Por favor seleccone una iamgen", Toast.LENGTH_SHORT).show();
                }else{
                    recnocerTextoDeImagen();
                }
            }
        });
    }

    private void recnocerTextoDeImagen() {
    ...
    private void AbrirCamara(){
        ...
        values.put(MediaStore.Images.Media.DESCRIPTION, "Decripcion");
            ...
            new ActivityResultCallback<ActivityResult>() {
                ...
                public void onActivityResult(ActivityResult result) {
                    if (result.getResultCode()==Activity.RESULT_OK){
                        ...
                        Toast.makeText(MainActivity.this, "Cancelada por el usuario", Toast.LENGTH_SHORT).show();
                    }
                }
            }
    );
